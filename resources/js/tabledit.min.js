...
!function (t) {
    ...
    t.fn.Tabledit = function (e) {
        function n(e) {
            var n = i.find(".tabledit-input").serialize() + "&action=" + e, a = d.onAjax(e, n);
            if (a === !1) return !1;
        ...
        }, d = t.extend(!0, a, e), s = "undefined", o = "undefined", l = "undefined", r = {
            columns: {
                identifier: function () {
        ...
        return r.columns.identifier(), r.columns.editable(), r.columns.toolbar(), d.onDraw(), d.deleteButton && (i.on("click", "button.tabledit-delete-button", function (e) {
            ...
            if (e.handled !== !0) {
                e.preventDefault();
                var n = t(this), a = n.hasClass("active");
            ...
            var e = i.find(".tabledit-input:visible"), n = i.find(".tabledit-confirm-button");
