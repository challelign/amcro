            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header" style="font-size: 20px">
                        ባሕርዳር ኤፍኤም ማስታወቂያ አስተካክለህ መዝግብ
                        @if($todayDate = date("d-m-yy"))
                        @endif
                    </div>
                    @include('layouts.errors')
                    <form action="{{route('mastawokia-update-fm',$mastawokia->id)}}" method="post" id="dynamic_form" class="form-group">
                        @csrf
                        <span id="result"></span>
                        <div class="card-body">
                            <div class="row">
...
{{--                                <td><input type="number" name="mastawokia_Yetestenagedew_meten" min="1" id="mastawokia_Yetestenagedew_meten" value="{{$mastawokia->mastawokia_Yetestenagedew_meten}}"  required class="form-control"/></td>--}}
                            ...
                            <div class="form-group row ">
                                <div class="col-md-4 ">
                                    <a href="{{route('program-list-by-date',$mastawokia->ProgramKen->id)}}" type="submit" class="btn btn-info ">
                                        ተመለስ
                                    </a>
