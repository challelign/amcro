...
{{--                        <span id="result"></span>--}}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <textarea type="text" id="fmmall" class="form-control" value="" name="fmmall"></textarea>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#SubmitForm').on('submit', function (e) {
                ...
                let fmmallnew = $('#fmmall').val();

                $.ajax({
                    url: '{{route('mastawokia-save-formnew-fm')}}',
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                    ...
                    error: function (response) {
                        ...
                        $('#fmmallErrorMsg').text(response.responseJSON.errors.fmmall);
                    },
                });
            });
