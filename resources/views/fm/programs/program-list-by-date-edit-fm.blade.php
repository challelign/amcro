        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card ">
                    ...
                    @include('layouts.errors')
                    <form action="{{route('program-list-by-date-update-fm',$program->id)}}" method="post"
                          class="form-group">
                        @csrf
                        <span id="result"></span>
                        <div class="card-body">
...
{{--                                                                                            <option selected disabled>ፕሮግራሙ ሚተላለፍበትን ሰዓት ይምረጡ</option>--}}
                            ...
                            <table class="table table-bordered table-striped table-responsive form-group"
                                ...
                                <tr>
                                    <TH style="width: 150px">ፕሮግራም አይዲ</TH>
                                    <TH>ፋይል ስም</TH>
                                    <TH style="width: 50px">ደቂቃ</TH>
                                    <TH>ሚተላለፍበትን ሰዓት</TH>
                                    <TH>የፕሮግራሙ ይዘት *</TH>
                                    <TH>አርታሺ *</TH>
                                    <TH>አዘጋጅ *</TH>
                                ...
                                <td><input type="text"  style="width: 75px" name="program_minute" id="program_minute"
                                ...
                                <td><textarea class="form-control" name="program_yizet" id="program_yizet" rows="4"
                            ...
                            <div class="form-group row ">
                                <div class="col-md-4 ">
                                    <a href="{{route('program-list-by-date-tewat-fm',$program->programKen->id)}}" type="submit"
                                       class="btn btn-info ">
                                        ተመለስ
                                    </a>
