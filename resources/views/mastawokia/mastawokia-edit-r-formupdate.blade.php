            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    ...
                    <div class="card-header" style="font-size: 20px">
                        የአማራ ራዲዮ ዛሬ ሚተላለፉ ማስታወቂያ አስተካክል
                        @if($todayDate = date("d-m-yy"))
                        @endif
                    </div>
                    @include('layouts.errors')
                    <form action="{{route('mastawokia-update-r-formnewsave',$mastawokia->id)}}"  method="post" id="SubmitForm" class="form-group">
                        @csrf

                        <div class="card-body">

                            <div class="float-right">
                                <a href={{route('mastawokia-create')}} type="submit" class="btn btn-danger ">
                                    ወደ ዋናው መመዝገቢያ
                                </a>
                            </div>
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <textarea type="text" id="rmall" class="form-control" value="" name="rmall">{{$mastawokia->rmall}}</textarea>
...
<script>
    $(document).ready(function () {
        ClassicEditor.create(document.getElementById('rmall'), {}).then(editor => {
