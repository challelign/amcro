    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header bg-info" style="color: white ;font-size: 20px">የአማራ ራዲዮ ያልተላለፉ ማስታወቂያዎች ዝርዝር</div>
                    <div class="card-body">
...
{{--                            <TH>የተስተናገደው መጠን</TH>--}}
                            ...
                            @foreach($mastawokia as $ms)
                                @if($ms->is_artayi_check == 1 && $ms->is_transmit == 1 && $ms->not_transmit == 1)
                                    @if($i++)@endif
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td> {{$ms->today_date}}</td>
...
{{--                                <TH>የተስተናገደው መጠን</TH>--}}
                        ...
                        <div class="col-md-6"> {{ $mastawokia->links() }}</div>
