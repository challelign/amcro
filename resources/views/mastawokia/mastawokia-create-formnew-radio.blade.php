    ...
    <script>
        ...
        $(document).ready(function () {
            $('#SubmitForm').on('submit', function (e) {
                ...
                $.ajax({
                    url: '{{route('mastawokia-save-formnew-radio')}}',
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}",
                    ...
                    error: function (response) {
                        ...
                        $('#fmmallErrorMsg').text(response.responseJSON.errors.rmall);
                    },
                });
            });
