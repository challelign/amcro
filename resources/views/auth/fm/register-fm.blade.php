            ...
            <div class="col-md-12 row">
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div>
                            <a href="{{route('register-user-fm')}}" class="btn btn-info float-right">ተጠቃሚ መዝግብ</a>
                        </div>
                        <div class="card-body">
                            <form
                                action="{{isset($user_data) ? route('user-update-fm',$user_data->id):route('register-create-fm')}} "
                                method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select required class="form-control @error('role_id') is-invalid @enderror"
                                            ...
                                            @foreach($role as $r)
                                                @if($r->id == 3 || $r->id == 4  || $r->id == 1 || $r->id == 2 || $r->id == 7 || $r->id == 9 || $r->id == 10 || $r->id == 11 || $r->id == 12 || $r->id == 13 )
                                                    @continue
                                                @endif
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTableAdmin" class="table table-bordered table-striped">
                                    ...
                                    @if($i = 0)@endif
                                    @foreach($users as $us)
                                        @if($us->role->id == 3 || $us->role->id == 4  || $us->role->id == 1 || $us->role->id == 2 || $us->role->id == 7 || $us->role->id == 9 || $us->role->id == 10  || $us->role->id == 11|| $us->role->id == 12|| $us->role->id == 13)
                                            @continue
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('user-edit-fm',$us->id)}}"
                                                   class="btn btn-primary btn-sm">Edit</a>
                                            </td>
                                            <td><a href="{{route('user-delete-fm',$us->id)}}"
