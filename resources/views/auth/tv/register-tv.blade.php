            ...
            <div class="col-md-12 row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div>
                            <a href="{{route('register-user-tv')}}" class="btn btn-info float-right">ተጠቃሚ መዝግብ</a>
                        </div>
                        <div class="card-body">
                            <form
                                action="{{isset($user_data) ? route('user-update-tv',$user_data->id):route('register-create-tv')}} "
                                method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select required class="form-control @error('role_id') is-invalid @enderror"
                                            ...
                                            @foreach($role as $r)
                                                @if($r->id == 5 || $r->id == 6  || $r->id == 1 || $r->id == 2 || $r->id == 7 || $r->id == 8 || $r->id == 9 || $r->id == 10 || $r->id == 11 || $r->id == 12 || $r->id == 13)
                                                    @continue
                                                @endif
                                ...
                                <table id="dataTableAdmin" class="table table-bordered table-striped">
                                    ...
                                    @foreach($users as $us)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('user-edit-tv',$us->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                            </td>
                                            <td><a href="{{route('user-delete-tv',$us->id)}}"
