            ...
            <div class="col-md-12 row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div>
                            <a href="{{route('register-user')}}" class="btn btn-info float-right">ተጠቃሚ መዝግብ</a>
                        </div>
                        <div class="card-body">
                            <form
                                action="{{isset($user_data) ? route('user-update',$user_data->id):route('register-create')}} "
                                method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <select required class="form-control @error('role_id') is-invalid @enderror"
                                            ...
                                            @foreach($role as $r)
                                                @if($r->id == 3 || $r->id == 4  || $r->id == 5 || $r->id == 6 || $r->id == 7 || $r->id == 9 || $r->id == 10 || $r->id == 11|| $r->id == 12|| $r->id == 13)
                                                    @continue
                                                @endif
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTableAdmin" class="table table-bordered table-striped">
                                    ...
                                    @if($i = 0)@endif
                                    @foreach($users as $us)
                                        @if($us->role->id== 3 || $us->role->id == 4  || $us->role->id == 5 || $us->role->id== 6 ||  $us->role->id == 7 ||  $us->role->id== 9 ||  $us->role->id == 10 ||  $us->role->id== 11||  $us->role->id== 12||  $us->role->id== 13)
                                            @continue
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('user-edit',$us->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                            </td>
                                            <td><a href="{{route('user-delete',$us->id)}}"
