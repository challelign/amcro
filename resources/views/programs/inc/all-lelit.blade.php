                    ...
                    @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 2 || \Illuminate\Support\Facades\Auth::user()->role_id == 8 || \Illuminate\Support\Facades\Auth::user()->role_id == 12)
                        ...
                        <div class="row no-print">
                            <div class="col-md-10">
                                ...
                                @if($i > 0)
                                    @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1)
                                        <a href="{{route('program-list-by-date-lelit-print',$ken->id)}}" target="_blank"
                        ...
                        <div class="row no-print">
                            <div class="col-md-10">
                                ...
                                @if($x > 0)
                                    @if(\Illuminate\Support\Facades\Auth::user()->role_id == 10)
                                        <a href="{{route('program-list-by-date-lelit-print',$ken->id)}}"
                                           target="_blank"
                                           class="btn btn-primary float-right"
                                           style="margin-right: 5px;">
                                            <i class="fas fa-download"></i>
        ...
        $(function () {
            ...
            function sendOrderToServer() {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ url('programs/1/program-list-by-date-lelit') }}",
                    data: {
                        order: order,
                        _token: '{{csrf_token()}}'
                    },
