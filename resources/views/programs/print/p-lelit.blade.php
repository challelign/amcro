...
&&   $mas->is_transmit == 0 && $mas->program_mitelalefbet == 'ሌሊት[6:00-12:00]')
@if($i++)@endif
@endif
@endforeach
    <!doctype html>
...
<head>
    ...
    <title>ዕለቱ @if(\Illuminate\Support\Facades\Auth::user()->role_id == 10  ) {{$mas->name}}  ሌሊት[6:00-12:00]
        ቀን {{$mas->today_date}} @else ዕለቱ {{$ken->name}} ሌሊት[6:00-12:00] ቀን {{$pro->today_date}} @endif  </title>


    {{--    <title>ዕለቱ {{$ken->name}} ሌሊት[6:00-12:00] ቀን {{$pro->today_date}} </title>--}}
