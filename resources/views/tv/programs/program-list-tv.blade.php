...
@section('content')
    <div class="container-fluid">
        <div class="row" style="margin-right: -30px; margin-left: -30px; border: 0px">
            <div class="col-md-12">
                @include('layouts.tvtp')
                <div class="card">
                    <div class="card-header bg-info" style="color: white ;font-size: 20px">የአማራ ቴሌቪዥን ዓየርላይ የዋሉ ፐሮግራሞች ዝርዝር</div>
                    <div class="card-body">
                            ...
                            @foreach($program as $pro)
                                @if($pro->is_transmit == 1 && $pro->is_artayi_check == 1)
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: auto">{!! $pro->program_yizet !!}</td>
                                        <td>{{$pro->artayi}}</td>
                                        <td>{{$pro->user->name}}</td>
                                        <td>{{$pro->technician}}</td>
                                        <td>{{$pro->supervisor}}</td>
