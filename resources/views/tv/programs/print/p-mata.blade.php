...
&&   $mtv->is_transmit == 0 && $mtv->program_mitelalefbet == 'ማታ[12:00-6:00]')
@if($i++)@endif
@endif
@endforeach
    <!doctype html>
...
<head>
    ...
    <title>ዕለቱ @if(\Illuminate\Support\Facades\Auth::user()->role_id == 10 ) {{$mtv->name}}  ማታ[12:00-6:00]
        ቀን {{$mtv->today_date}} @else  {{$ken->name}} ማታ[12:00 - 6:00]  ቀን {{$pro->today_date}} @endif  </title>
