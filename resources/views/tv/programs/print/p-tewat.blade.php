...
<head>
    ...
    <title>ዕለቱ @if(\Illuminate\Support\Facades\Auth::user()->role_id == 10 ) {{$mtv->name}} ጠዋት[12:00-6:00]
        ቀን {{$mtv->today_date}} @else {{$ken->name}} ጠዋት[12:00-6:00] ቀን {{$pro->today_date}} @endif  </title>
