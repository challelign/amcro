...
&&   $mtv->is_transmit == 0 && $mtv->program_mitelalefbet == 'ሌሊት[6:00-12:00]')
@if($i++)@endif
@endif
@endforeach
    <!doctype html>
...
<head>
    ...
    <title>ዕለቱ @if(\Illuminate\Support\Facades\Auth::user()->role_id == 10 ) {{$mtv->name}}   ሌሊት[6:00 - 12:00] ቀን
        ቀን {{$mtv->today_date}} @else  {{$ken->name}}  ሌሊት[6:00 - 12:00] ቀን {{$pro->today_date}} @endif  </title>
