                                                ...
                                                <td>
                                                    <form action="{{route('program-approve-tech-tv',$pro->id)}}"
                                                        ...
                                                        @if($pro->is_transmit == '0' && $pro->is_artayi_check == '1'  && $pro->is_supervisor == 1)
                                                            ...
                                                            <h4 class="bg-danger text-center text-white">ያልተላለፈ ፕሮግራም ካለ የአስተያየት መስጫው ጋ ምክንያቱን መዝግብ</h4>
                ...
                <!-- Modal for Mastawokia -->
                    ...
                    <div class="row no-print">
                        <div class="col-md-10">
                            ...
                            @if($i > 0 )
                                @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3)
                                    <a href="{{route('program-list-by-date-mata-print-tv',$ken->id)}}" target="_blank"
