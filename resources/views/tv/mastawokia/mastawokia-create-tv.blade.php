                    ...
                    <form action="" method="post" id="dynamic_form" class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="float-right">
                                <a href={{route('mastawokia-create-formnew-tv')}} type="submit" class="btn btn-danger ">
                                    አማራጭ መመዝገቢያ
                                </a>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function dynamic_field(number) {
                ...
                html += '<td><input type="text" name="mastawokia_video_id[]" required id="mastawokia_video_id" class="form-control"/></td>';
